...
***This repository is a reorganization of the [yara-rules/rules](https://github.com/Yara-Rules/rules) repo to make it easier to determine the file type targeted by the YARA rules. The following is the original repository text:***
